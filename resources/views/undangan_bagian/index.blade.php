        ...
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $no=1;?> 
                @foreach ($undangan_bagian as $val) 
              <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">{{ $val->bagian_id }}</div>
              </td>

                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <a href=" {{ route('undangan_bagian.edit',['id'=>$val->id]) }}" >
                    ...
                    <a href=" {{ route('undangan_bagian.show',['id'=>$val->id]) }}">
                    ...
                    <a href=" {{ route('undangan_bagian.delete',['id'=>$val->id]) }}">
          ...
          <a href=" {{ route('undangan_bagian.create') }}" >
