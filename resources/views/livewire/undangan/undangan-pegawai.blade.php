    ...
    <div class="flex flex-col">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $no=1;?> 
                    @if($undanganPegawai!=null && $undanganPegawai->count()>=1)
                    @foreach ($undanganPegawai as $val) 
                  <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{ $val->undangan->judul }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{ $val->pegawai->name }}</div>
                  </td>
                    {{-- <td class="px-6 py-4 whitespace-nowrap">
