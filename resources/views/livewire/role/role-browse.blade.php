                ...
                <div class="w-full md:flex md:w-1/2">
                    <div class="w-full flex justify-start mt-2">
                        <div class="w-full inline-block relative ">
                            ...
                            <input wire:model="roleId" type="hidden"> {{-- roleId untuk mengambil id --}}
                            <input wire:model.defer="namaRole" type="text" placeholder="Input Nama" 
                                class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            
                            {{-- input deskripsi --}}
                            <input wire:model.defer="deskripsiRole" type="text" placeholder="Input Deskripsi"
                            class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex-inline">
                                            ...
                                            {{-- <button class="text-green-700 py-1 px-2  rounded-md">
                                                <svg wire:click="$emitTo('role.show', 'onShowRole','{{ $val->id }}')"   class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path><path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"></path></svg>
                                            </button> --}}
